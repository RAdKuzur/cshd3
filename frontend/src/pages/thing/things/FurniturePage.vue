    ...
    <div class="max-w-8xl mx-auto">
      ...
      <div class="mb-8">
        <div class="flex justify-between items-center">
          <div>
            <h1 class="text-3xl font-bold text-gray-900">Мебель</h1>
                  ...
                  <div class="flex-shrink-0 h-8 w-8 bg-green-100 rounded-lg flex items-center justify-center mr-3">
                    ...
                    >
                      <path
                          ...
                          stroke-width="2"
                          d="M8 4v16M8 4h6a4 4 0 010 8H8m0 4h6"
                      />
                    </svg>
                  </div>
                  <div>
...
const loadData = async () => {
  try {
    ...
    const [furnitureResponse, typesResponse, balanceResponse, auditoriumsResponse] = await Promise.all([
      axios.get(BACKEND_URL + '/api/things/furniture'),
    ...
    if (furnitureResponse.data.success) {
      items.value = furnitureResponse.data.data.map(item => {
