        ...
        <form @submit.prevent="handleSubmit">
          ...
          <div v-if="formData.type" class="mb-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div v-if="formData.type === 1  || formData.type === 4 || formData.type === 5 || formData.type === 2 || formData.type === 6">
                <label class="block text-sm font-medium text-gray-700 mb-2">
                  Кто (принимает) *
                </label>
                <select
                ...
                <p class="mt-1 text-sm text-gray-500">
                  <template v-if="(formData.type === 1 || formData.type === 4 || formData.type === 5 || formData.type === 6 )">
...
<!--              </div>-->
          ...
          <div class="flex items-center justify-end gap-4 pt-6 border-t border-gray-200">
            ...
            <button
                type="submit"
                :disabled="isSubmitting || isLoading || selectedThingsCount === 0 || !formData.type || !formData.date || ((formData.type === 1  || formData.type === 4 || formData.type === 5 || formData.type === 6) && !formData.to) || (formData.type === 2 && (!formData.from || !formData.to)) || (formData.type === 3 && !formData.from)"
...
const shouldShowThingsSection = computed(() => {
  ...
  if (formData.type === 1 || formData.type === 4 ||formData.type === 5 || formData.type === 6) {
    return true
...
watch(() => formData.type, (newType) => {
  if ((newType === 1 || newType === 4 || newType === 5  || newType === 6 ) && people.value.length > 0) {
...
watch(() => people.value, (newPeople) => {
  if (newPeople.length > 0 && (formData.type === 1 || formData.type === 4 || formData.type === 5 || formData.type === 6 )) {
...
const handleSubmit = async () => {
  try {
    ...
    } else if ((formData.type === 1  || formData.type === 4 || formData.type === 5 || formData.type === 6) && !formData.to) {
      isValid = false
    ...
    const dataToSend = {
      ...
      from: (formData.type === 1 || formData.type === 4 || formData.type === 5 || formData.type === 6) ? null : parseInt(formData.from),
