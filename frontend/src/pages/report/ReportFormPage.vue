        ...
        <div class="p-6 border-b border-gray-100">
          <div class="mb-6">
            ...
            <p class="mt-2 text-sm text-gray-500">
              Данные будут сформированы за период на 31 декабря {{ selectedYear }} года
            </p>
          </div>
              ...
              <div class="flex items-start justify-between mb-4">
                <div>
                  ...
                  <p class="text-gray-600 text-sm leading-relaxed mb-6">
                    Базовая форма отчетности по материальным ценностям организации.
                  </p>
                </div>
              </div>
            ...
            <div class="bg-gradient-to-br from-emerald-50 to-teal-50 rounded-2xl border border-emerald-100 p-6 hover:border-emerald-200 transition-all group">
              <div class="flex items-start justify-between mb-4">
                <div>
                  ...
                  <p class="text-gray-600 text-sm leading-relaxed mb-6">
                    Расширенная форма с детализацией материальных ценностей.
                  </p>
                </div>
              </div>
